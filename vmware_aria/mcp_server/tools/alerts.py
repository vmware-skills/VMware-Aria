...
def list_alerts(
    ...
    resource_name, resource_kind, timestamps (start/update *_time_ms, and
    start_time_utc / update_time_utc in ISO-8601 UTC), and control state. resource_name
