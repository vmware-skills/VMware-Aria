...
``VMWARE_ARIA_CONFIG``, then ``CONFIG_FILE`` — was consolidated into
...
from vmware_aria.config import CONFIG_FILE, resolve_config_path

_ENV = "VMWARE_ARIA_CONFIG"
...
def test_the_server_hands_the_loader_the_resolvers_own_default():
    ...
    from vmware_aria import policy_environment
