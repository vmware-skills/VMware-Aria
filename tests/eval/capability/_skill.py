...
ENTITY_WORDS = {
    'alert': ('alert', 'alerts'),
    'definition': ('definition', 'definitions', 'alert_definition', 'symptom_definition', 'report_definition'),
...
NOT_AN_ENTITY = frozenset(
    {
        # ``resource_kind`` is a type token from the caller's intent, not an
        # instance discovered from an API.
        'description',
        'enabled',
        'resource_kind',
    }
