...
```bash
pip install vmware-aria==1.15.0
```

### From source

```bash
git clone --branch v1.15.0 https://github.com/vmware-skills/VMware-Aria.git
cd VMware-Aria
pip install -e .
```
...
> If using `uvx --from vmware-aria==1.15.0 vmware-aria mcp` and you hit
