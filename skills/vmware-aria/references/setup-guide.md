...
```bash
pip install vmware-aria==1.14.1
```

### From source

```bash
git clone --branch v1.14.1 https://github.com/vmware-skills/VMware-Aria.git
cd VMware-Aria
pip install -e .
```
...
> If using `uvx --from vmware-aria==1.14.1 vmware-aria mcp` and you hit
